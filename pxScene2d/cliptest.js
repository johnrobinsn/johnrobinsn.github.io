...
// TODO clip:true seems to be broken when async loading the texture from url
var ball = scene.createImage({x:450,y:350,parent:root,clip:false,onReady:function(e) {
    var ball = e.target;
